 ...
 * @param phone    số điện thoại duy nhất của người dùng (không bắt buộc)
...
public record AuthRegisterRequest(
		...
		@Pattern(regexp = "^\\s*$|^\\S.{8,18}\\S$", message = "Phone must be between 10 and 20 characters when provided") String phone,
